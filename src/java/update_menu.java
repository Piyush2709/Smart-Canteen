...
public class update_menu extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      String query1 = "Update tbl_menu set menu_name='" +menu_name+ "', menu_price='" +menu_price+ "',menu_img='Img/" +menu_img+ "', menu_description='" +menu_description+ "'WHERE menu_id='" +menu_id+ "'";
      String result = db.Query(query1, "Record Updated"); 
    out.println(result);

}
            else if (event.equals("Delete")) {
            String deleteQuery = "DELETE FROM tbl_menu WHERE menu_id='" + menu_id + "'";
            ...
            out.println("<script>");
            out.println("alert('Menu Updated successful');");
            out.println("window.location='view_menu.jsp';");
            out.println("</script>");
        }
    }
