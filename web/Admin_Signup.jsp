...
<head>
  ...
  <link href="assets/img/Logo Smart.png" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form action="Admin_Signup" method="post" novalidate>
                    <div class="row g-3 needs-validation">
                      ...
                      <div class="col-12">
                        <button type="submit" class="btn btn-primary w-100" name="btn_save" value="btn_save">Create Account</button>
                      </div>
                      <div class="col-12">
                        <p class="small mb-0">Already have an account? <a href="admin_Login.jsp">Log in</a></p>
                      </div>
                    </div>
                  </form>
                </div>
