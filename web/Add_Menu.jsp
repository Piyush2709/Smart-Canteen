        ...
        <div class="row">
          ...
          <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" maxlength="10" class="form-control" name="menu_price" placeholder="Enter Menu Price" required="">
                  </div>
                </div>
                ...
                <div class="col-sm-6"><br>
                  ...
                  <div class="form-group"><br>
                        ...
                        <textarea name="menu_description" class="form-control" rows="3" placeholder="Enter Description....." required=""></textarea>
                      </div>
