           ...
           <form action="update_emp" method="POST">
              <tbody>
                <tr>
                  ...
                  <td><input type="text" class="form-control" name="emp_name" value="<%= rs.getString("emp_name") %>"></td>
                  <td><input type="text" class="form-control" name="emp_no" value="<%= rs.getString("emp_no") %>"></td>
                  <td><input type="text" class="form-control" name="emp_address" value="<%= rs.getString("emp_address") %>"></td>
                  <td><input type="file" class="custom-file-input" id="" name="emp_profile"></td>
                  <td><input type="file" class="custom-file-input" id="" name="emp_proof"></td>
                  <td>
