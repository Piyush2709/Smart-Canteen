            ...
            <form action="update_menu" method="POST">
              <tbody>
                <tr>
                  ...
                  <td><input type="text" class="form-control" name="menu_name" value="<%= rs.getString("menu_name") %>"></td>
                  <td><input type="text" class="form-control" name="menu_price" value="<%= rs.getString("menu_price") %>"></td>
                  <td><input type="text" class="form-control" name="menu_description" value="<%= rs.getString("menu_description") %>"></td>
                  <td><input type="file" class="custom-file-input" id="" name="menu_img"></td>
                  <td>
