...
<main id="main" class="main">
 <form action="emp_attendance" method="POST">
    ...
    <div class="col-12">
              <div class="card recent-sales overflow-auto">
                  ...
                  <div class="card-body">
                  <h5 class="card-title">Attedance <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">1</th>
                        <td><select class="custom-select form-control-border" id="emp_name" name="emp_name">
                    <option value="">Select Employee</option>
                          ...
                          %>
                          <option><%=rs.getString("emp_name")%></option>
                          <%
                          }
                          }catch(Exception ex)
{
    ...
    <input type="date" id="date" name="date">
                         ...
                         <td>
                            <select name="status" id="status" calss="dropdown-menu" >
                        ...
                        <td>
                            <button type="submit" class="btn btn-danger"name="btn_save" value="btn_save">Update</button>
                        </td>
                      </tr>
